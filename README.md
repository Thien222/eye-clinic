...
| 👨‍⚕️ **Khám mắt** | Khám tổng quát, ghi chẩn đoán |
...
> ⚠️ **Không cần cài đặt Node.js** - Đã tích hợp sẵn trong thư mục `release/bin/`
...
> ⚠️ **QUAN TRỌNG:** Không tắt cửa sổ màn hình đen (Server đang chạy)
...
- 📁 **Dữ liệu lưu tại:** `release/database.json`
- 💾 **Backup:** Trong Settings → Backup & Restore
- 📧 **Liên hệ:** [Mở Issue trên GitHub](https://github.com/Thien222/eye-clinic/issues)
